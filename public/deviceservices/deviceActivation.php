...
error_log("Device Activation Request: " . $input);
...
$serial_number = 'F4GTGYJZHG7F';
$unique_device_id = '0a46305ca2ec80f97f28a22b7b977c45a01c828a';
$imei = '355324087826421';
...
// Create the activation response in HTML format like the sample
...
error_log("Device Activation Response generated for device: " . $unique_device_id);
echo $response;
?>
